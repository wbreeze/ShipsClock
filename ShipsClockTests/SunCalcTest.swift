    ...
    func testCases() -> [TestCase] {
        [
            TestCase(
                ...
                expectedRa: Arcs.hmsToAngle(5, 34, 31),
                expectedHa: Arcs.hmsToAngle(1, 37, 32)),
            TestCase(
                description: "EastPM",
                julianDay: jules.julianDay(2020, 6, 14, 19, 25, 0),
                longitude: TestCase.eastLon,
                expectedRa: Arcs.hmsToAngle(5, 36, 3),
                expectedHa: Arcs.hmsToAngle(9, 55, 39)),
            TestCase(
                description: "WestAM",
            ...
            TestCase(
                ...
                longitude: TestCase.westLon,
                expectedRa: Arcs.hmsToAngle(6, 0, 53),
                expectedHa: Arcs.hmsToAngle(9, 43, 10)),
            TestCase(
                description: "21 June West PM",
                julianDay: jules.julianDay(2020, 6, 22, 2, 42, 0),
                longitude: TestCase.westLon,
                expectedRa: Arcs.hmsToAngle(6, 5, 3),
                expectedHa: Arcs.hmsToAngle(9, 42, 57)),
        ]
    }
